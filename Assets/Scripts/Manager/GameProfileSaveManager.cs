...
public class GameProfileSaveManager : MonoSingleton<GameProfileSaveManager>
{
    ...
    private void OnGUI()
    {
        ...
        {
            GUILayout.Space(60);
            GUILayout.Label("LastastLevel-：" + currentProfileData.lastestLevel);
            GUILayout.Label("LastastLevel-UnLock?：" + currentProfileData.levelDatas[currentProfileData.lastestLevel-1].isUnLock);
            GUILayout.Label("Level1Level-：" + currentProfileData.levelDatas[0].levelLevel);
        }
    }
